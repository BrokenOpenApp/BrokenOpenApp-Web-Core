...
class Version20150525155312 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
	{
		...
		$this->addSql('CREATE TABLE boa_issue (id BIGINT NOT NULL, project_id INT NOT NULL, number BIGINT NOT NULL, fingerprint VARCHAR(32) NOT NULL, title VARCHAR(250) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
		$this->addSql('CREATE INDEX IDX_99C126CB166D1F9C ON boa_issue (project_id)');
		$this->addSql('CREATE UNIQUE INDEX issue_fingerprint_unique ON boa_issue (project_id, fingerprint)');
		$this->addSql('CREATE UNIQUE INDEX issue_number_unique ON boa_issue (project_id, number)');
