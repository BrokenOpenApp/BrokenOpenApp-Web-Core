...
class Version20150525155312 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
	{
		...
		$this->addSql('CREATE TABLE incoming_crash_acra (id INT NOT NULL, project_id INT NOT NULL, incoming_crash_key VARCHAR(250) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
		...
		$this->addSql('CREATE TABLE issue (id BIGINT NOT NULL, project_id INT NOT NULL, number BIGINT NOT NULL, fingerprint VARCHAR(32) NOT NULL, title VARCHAR(250) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
		...
		$this->addSql('CREATE TABLE issue_history_title (id BIGINT NOT NULL, issue_id BIGINT NOT NULL, user_id INT NOT NULL, title VARCHAR(250) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
		...
		$this->addSql('CREATE TABLE project (id INT NOT NULL, title TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
		$this->addSql('CREATE TABLE user_account (id INT NOT NULL, password VARCHAR(64) DEFAULT NULL, email VARCHAR(200) NOT NULL, is_super_admin BOOLEAN NOT NULL, is_create_project BOOLEAN NOT NULL, is_locked BOOLEAN NOT NULL, is_all_projects_read BOOLEAN NOT NULL, is_all_projects_write BOOLEAN NOT NULL, is_all_projects_admin BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
